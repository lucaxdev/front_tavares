...
class Listar extends Component {
    ...
    async componentDidMount() {
        const { data: response } = await api.get('/catalog')
        let itens = response
    ...
    async sendCatalog() {
        ...
        const enviar = await api.post('/catalog', value)
                ...
                <div className="Catalogo-content">
                    ...
                    <div className="Catalogo-Cards">
                        ...
                        <div className="Catalogo-section">
                            ...
                            <div id="Section2">
                                <label>Catálogos Cadastrados</label>
